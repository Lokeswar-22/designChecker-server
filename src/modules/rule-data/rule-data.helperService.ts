...
export class RuleDataHelperService {
  ...
  // Common constants
  private readonly FETCH_LIMIT = 500; // keep pagination large for fetching
  private readonly SAVE_CHUNK_SIZE = 200; // REDUCED for MSSQL parameter limit (2100/~10 fields = ~210 max)
  ...
  async rule5(elementGroupId: string, accUserId: string) {
    ...
    // FIXED:sss Use smaller chunk size to avoid MSSQL parameter limit
